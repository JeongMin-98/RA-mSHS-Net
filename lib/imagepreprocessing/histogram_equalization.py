...
# reference from https://github.com/jstar0525/MachineVision/blob/main/04%20Histogram%20equalization/histogram_equalization.py
#
# -----------------------------------------------------------

# Test Image Path data/coco/images/Foot_New_Doctor/0.png
...
# image 1
img_1 = Image.open('data/coco/images/Foot_New_Doctor/0.png').convert('L')
