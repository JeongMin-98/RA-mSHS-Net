...
# Modifications by JeongMin Kim
# Copyright (c) 2024 JeongMin Kim
# This JointsDataset is used for loading COCO Dataset(Xray Image) and cropping Image
# ------------------------------------------------------------------------------
